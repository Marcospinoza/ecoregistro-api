...
(async () => {
    try {
        ...
        await pool.query(`SELECT id, nombre, usuario, password_hash, activo FROM public.usuarios LIMIT 0`);
        ...
        console.table((await pool.query(`SELECT id, nombre, usuario, activo FROM public.usuarios ORDER BY usuario`)).rows);
